...
import com.example.bookmanagement.Filters.FilterPdfUser;
...
import com.example.bookmanagement.databinding.RowPdfUserBinding;
...
public class AdapterPdfUser extends RecyclerView.Adapter<AdapterPdfUser.HolderPdfUser> implements Filterable {
    ...
    private static final String TAG = "ADAPTER_USER";
    ...
    public void onBindViewHolder(@NonNull HolderPdfUser holder, int position) {
        ...
        MyApplication.laodPdfsize(""+pdfUrl, ""+title, holder.sizeTv);
